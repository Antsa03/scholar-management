"use client";
import { NavbarTopCompositionDatas } from "@/constants/navbarTopComposition";
import Link from "next/link";
import { usePathname } from "next/navigation";
import React, { Fragment } from "react";

function NavbarTopComposition() {
  const pathname = usePathname();
  return (
    <nav className="navbartop-container">
      {NavbarTopCompositionDatas.map((item, index) => (
        <Fragment key={index}>
...
export default NavbarTopComposition;
