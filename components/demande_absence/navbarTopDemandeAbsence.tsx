"use client";
import { NavbarTopDemandeAbsenceDatas } from "@/constants/navbarTopDemande_absence";
import Link from "next/link";
import { usePathname } from "next/navigation";
import React, { Fragment } from "react";

function NavbarTopDemandeAbsence() {
  const pathname = usePathname();
  return (
    <nav className="navbartop-container">
      {NavbarTopDemandeAbsenceDatas.map((item, index) => (
        <Fragment key={index}>
...
export default NavbarTopDemandeAbsence;
